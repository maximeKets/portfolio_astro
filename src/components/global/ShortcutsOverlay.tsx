    ...
    <div className="fixed inset-0 z-[80]" role="dialog" aria-modal="true" aria-label="Keyboard shortcuts">
      ...
      <div className="relative mx-auto mt-20 w-[92%] max-w-2xl rounded-xl border border-white/10 bg-gray-900/95 shadow-2xl p-6">
        <div className="flex items-start justify-between mb-4">
          <h3 className="text-xl font-semibold text-white">{t('shortcuts.title')}</h3>
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-300">
          <li><kbd className="px-1.5 py-0.5 bg-white/10 rounded border border-white/10 mr-2">Cmd/Ctrl</kbd><kbd className="px-1.5 py-0.5 bg-white/10 rounded border border-white/10 mr-2">K</kbd>{t('shortcuts.openSpotlight')}</li>
          <li><kbd className="px-1.5 py-0.5 bg-white/10 rounded border border-white/10 mr-2">Esc</kbd>{t('shortcuts.closeModal')}</li>
          <li><kbd className="px-1.5 py-0.5 bg-white/10 rounded border border-white/10 mr-2">↑</kbd><kbd className="px-1.5 py-0.5 bg-white/10 rounded border border-white/10 mr-2">↓</kbd>{t('shortcuts.navigateList')}</li>
          <li><kbd className="px-1.5 py-0.5 bg-white/10 rounded border border-white/10 mr-2">Enter</kbd>{t('shortcuts.select')}</li>
          <li><kbd className="px-1.5 py-0.5 bg-white/10 rounded border border-white/10 mr-2">Space</kbd>{t('shortcuts.quickLook')}</li>
